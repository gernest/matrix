...
const Cc = _Cc; // Cc is the set of Unicode characters in category Cc.
const Cf = _Cf; // Cf is the set of Unicode characters in category Cf.
const Co = _Co; // Co is the set of Unicode characters in category Co.
const Cs = _Cs; // Cs is the set of Unicode characters in category Cs.
const Digit = _Nd; // Digit is the set of Unicode characters with the "decimal digit" property.
const Nd = _Nd; // Nd is the set of Unicode characters in category Nd.
const Letter = _L; // Letter/L is the set of Unicode letters, category L.
const L = _L;
const Lm = _Lm; // Lm is the set of Unicode characters in category Lm.
const Lo = _Lo; // Lo is the set of Unicode characters in category Lo.
const Lower = _Ll; // Lower is the set of Unicode lower case letters.
const Ll = _Ll; // Ll is the set of Unicode characters in category Ll.
const Mark = _M; // Mark/M is the set of Unicode mark characters, category M.
const M = _M;
const Mc = _Mc; // Mc is the set of Unicode characters in category Mc.
const Me = _Me; // Me is the set of Unicode characters in category Me.
const Mn = _Mn; // Mn is the set of Unicode characters in category Mn.
const Nl = _Nl; // Nl is the set of Unicode characters in category Nl.
const No = _No; // No is the set of Unicode characters in category No.
const Number = _N; // Number/N is the set of Unicode number characters, category N.
const N = _N;
const Other = _C; // Other/C is the set of Unicode control and special characters, category C.
const C = _C;
const Pc = _Pc; // Pc is the set of Unicode characters in category Pc.
const Pd = _Pd; // Pd is the set of Unicode characters in category Pd.
const Pe = _Pe; // Pe is the set of Unicode characters in category Pe.
const Pf = _Pf; // Pf is the set of Unicode characters in category Pf.
const Pi = _Pi; // Pi is the set of Unicode characters in category Pi.
const Po = _Po; // Po is the set of Unicode characters in category Po.
const Ps = _Ps; // Ps is the set of Unicode characters in category Ps.
const Punct = _P; // Punct/P is the set of Unicode punctuation characters, category P.
const P = _P;
const Sc = _Sc; // Sc is the set of Unicode characters in category Sc.
const Sk = _Sk; // Sk is the set of Unicode characters in category Sk.
const Sm = _Sm; // Sm is the set of Unicode characters in category Sm.
const So = _So; // So is the set of Unicode characters in category So.
const Space = _Z; // Space/Z is the set of Unicode space characters, category Z.
const Z = _Z;
const Symbol = _S; // Symbol/S is the set of Unicode symbol characters, category S.
const S = _S;
const Title = _Lt; // Title is the set of Unicode title case letters.
const Lt = _Lt; // Lt is the set of Unicode characters in category Lt.
const Upper = _Lu; // Upper is the set of Unicode upper case letters.
const Lu = _Lu; // Lu is the set of Unicode characters in category Lu.
const Zl = _Zl; // Zl is the set of Unicode characters in category Zl.
const Zp = _Zp; // Zp is the set of Unicode characters in category Zp.
const Zs = _Zs; // Zs is the set of Unicode characters in category Zs.
...
const Adlam = _Adlam; // Adlam is the set of Unicode characters in script Adlam.
const Ahom = _Ahom; // Ahom is the set of Unicode characters in script Ahom.
const Anatolian_Hieroglyphs = _Anatolian_Hieroglyphs; // Anatolian_Hieroglyphs is the set of Unicode characters in script Anatolian_Hieroglyphs.
const Arabic = _Arabic; // Arabic is the set of Unicode characters in script Arabic.
const Armenian = _Armenian; // Armenian is the set of Unicode characters in script Armenian.
const Avestan = _Avestan; // Avestan is the set of Unicode characters in script Avestan.
const Balinese = _Balinese; // Balinese is the set of Unicode characters in script Balinese.
const Bamum = _Bamum; // Bamum is the set of Unicode characters in script Bamum.
const Bassa_Vah = _Bassa_Vah; // Bassa_Vah is the set of Unicode characters in script Bassa_Vah.
const Batak = _Batak; // Batak is the set of Unicode characters in script Batak.
const Bengali = _Bengali; // Bengali is the set of Unicode characters in script Bengali.
const Bhaiksuki = _Bhaiksuki; // Bhaiksuki is the set of Unicode characters in script Bhaiksuki.
const Bopomofo = _Bopomofo; // Bopomofo is the set of Unicode characters in script Bopomofo.
const Brahmi = _Brahmi; // Brahmi is the set of Unicode characters in script Brahmi.
const Braille = _Braille; // Braille is the set of Unicode characters in script Braille.
const Buginese = _Buginese; // Buginese is the set of Unicode characters in script Buginese.
const Buhid = _Buhid; // Buhid is the set of Unicode characters in script Buhid.
const Canadian_Aboriginal = _Canadian_Aboriginal; // Canadian_Aboriginal is the set of Unicode characters in script Canadian_Aboriginal.
const Carian = _Carian; // Carian is the set of Unicode characters in script Carian.
const Caucasian_Albanian = _Caucasian_Albanian; // Caucasian_Albanian is the set of Unicode characters in script Caucasian_Albanian.
const Chakma = _Chakma; // Chakma is the set of Unicode characters in script Chakma.
const Cham = _Cham; // Cham is the set of Unicode characters in script Cham.
const Cherokee = _Cherokee; // Cherokee is the set of Unicode characters in script Cherokee.
const Common = _Common; // Common is the set of Unicode characters in script Common.
const Coptic = _Coptic; // Coptic is the set of Unicode characters in script Coptic.
const Cuneiform = _Cuneiform; // Cuneiform is the set of Unicode characters in script Cuneiform.
const Cypriot = _Cypriot; // Cypriot is the set of Unicode characters in script Cypriot.
const Cyrillic = _Cyrillic; // Cyrillic is the set of Unicode characters in script Cyrillic.
const Deseret = _Deseret; // Deseret is the set of Unicode characters in script Deseret.
const Devanagari = _Devanagari; // Devanagari is the set of Unicode characters in script Devanagari.
const Duployan = _Duployan; // Duployan is the set of Unicode characters in script Duployan.
const Egyptian_Hieroglyphs = _Egyptian_Hieroglyphs; // Egyptian_Hieroglyphs is the set of Unicode characters in script Egyptian_Hieroglyphs.
const Elbasan = _Elbasan; // Elbasan is the set of Unicode characters in script Elbasan.
const Ethiopic = _Ethiopic; // Ethiopic is the set of Unicode characters in script Ethiopic.
const Georgian = _Georgian; // Georgian is the set of Unicode characters in script Georgian.
const Glagolitic = _Glagolitic; // Glagolitic is the set of Unicode characters in script Glagolitic.
const Gothic = _Gothic; // Gothic is the set of Unicode characters in script Gothic.
const Grantha = _Grantha; // Grantha is the set of Unicode characters in script Grantha.
const Greek = _Greek; // Greek is the set of Unicode characters in script Greek.
const Gujarati = _Gujarati; // Gujarati is the set of Unicode characters in script Gujarati.
const Gurmukhi = _Gurmukhi; // Gurmukhi is the set of Unicode characters in script Gurmukhi.
const Han = _Han; // Han is the set of Unicode characters in script Han.
const Hangul = _Hangul; // Hangul is the set of Unicode characters in script Hangul.
const Hanunoo = _Hanunoo; // Hanunoo is the set of Unicode characters in script Hanunoo.
const Hatran = _Hatran; // Hatran is the set of Unicode characters in script Hatran.
const Hebrew = _Hebrew; // Hebrew is the set of Unicode characters in script Hebrew.
const Hiragana = _Hiragana; // Hiragana is the set of Unicode characters in script Hiragana.
const Imperial_Aramaic = _Imperial_Aramaic; // Imperial_Aramaic is the set of Unicode characters in script Imperial_Aramaic.
const Inherited = _Inherited; // Inherited is the set of Unicode characters in script Inherited.
const Inscriptional_Pahlavi = _Inscriptional_Pahlavi; // Inscriptional_Pahlavi is the set of Unicode characters in script Inscriptional_Pahlavi.
const Inscriptional_Parthian = _Inscriptional_Parthian; // Inscriptional_Parthian is the set of Unicode characters in script Inscriptional_Parthian.
const Javanese = _Javanese; // Javanese is the set of Unicode characters in script Javanese.
const Kaithi = _Kaithi; // Kaithi is the set of Unicode characters in script Kaithi.
const Kannada = _Kannada; // Kannada is the set of Unicode characters in script Kannada.
const Katakana = _Katakana; // Katakana is the set of Unicode characters in script Katakana.
const Kayah_Li = _Kayah_Li; // Kayah_Li is the set of Unicode characters in script Kayah_Li.
const Kharoshthi = _Kharoshthi; // Kharoshthi is the set of Unicode characters in script Kharoshthi.
const Khmer = _Khmer; // Khmer is the set of Unicode characters in script Khmer.
const Khojki = _Khojki; // Khojki is the set of Unicode characters in script Khojki.
const Khudawadi = _Khudawadi; // Khudawadi is the set of Unicode characters in script Khudawadi.
const Lao = _Lao; // Lao is the set of Unicode characters in script Lao.
const Latin = _Latin; // Latin is the set of Unicode characters in script Latin.
const Lepcha = _Lepcha; // Lepcha is the set of Unicode characters in script Lepcha.
const Limbu = _Limbu; // Limbu is the set of Unicode characters in script Limbu.
const Linear_A = _Linear_A; // Linear_A is the set of Unicode characters in script Linear_A.
const Linear_B = _Linear_B; // Linear_B is the set of Unicode characters in script Linear_B.
const Lisu = _Lisu; // Lisu is the set of Unicode characters in script Lisu.
const Lycian = _Lycian; // Lycian is the set of Unicode characters in script Lycian.
const Lydian = _Lydian; // Lydian is the set of Unicode characters in script Lydian.
const Mahajani = _Mahajani; // Mahajani is the set of Unicode characters in script Mahajani.
const Malayalam = _Malayalam; // Malayalam is the set of Unicode characters in script Malayalam.
const Mandaic = _Mandaic; // Mandaic is the set of Unicode characters in script Mandaic.
const Manichaean = _Manichaean; // Manichaean is the set of Unicode characters in script Manichaean.
const Marchen = _Marchen; // Marchen is the set of Unicode characters in script Marchen.
const Masaram_Gondi = _Masaram_Gondi; // Masaram_Gondi is the set of Unicode characters in script Masaram_Gondi.
const Meetei_Mayek = _Meetei_Mayek; // Meetei_Mayek is the set of Unicode characters in script Meetei_Mayek.
const Mende_Kikakui = _Mende_Kikakui; // Mende_Kikakui is the set of Unicode characters in script Mende_Kikakui.
const Meroitic_Cursive = _Meroitic_Cursive; // Meroitic_Cursive is the set of Unicode characters in script Meroitic_Cursive.
const Meroitic_Hieroglyphs = _Meroitic_Hieroglyphs; // Meroitic_Hieroglyphs is the set of Unicode characters in script Meroitic_Hieroglyphs.
const Miao = _Miao; // Miao is the set of Unicode characters in script Miao.
const Modi = _Modi; // Modi is the set of Unicode characters in script Modi.
const Mongolian = _Mongolian; // Mongolian is the set of Unicode characters in script Mongolian.
const Mro = _Mro; // Mro is the set of Unicode characters in script Mro.
const Multani = _Multani; // Multani is the set of Unicode characters in script Multani.
const Myanmar = _Myanmar; // Myanmar is the set of Unicode characters in script Myanmar.
const Nabataean = _Nabataean; // Nabataean is the set of Unicode characters in script Nabataean.
const New_Tai_Lue = _New_Tai_Lue; // New_Tai_Lue is the set of Unicode characters in script New_Tai_Lue.
const Newa = _Newa; // Newa is the set of Unicode characters in script Newa.
const Nko = _Nko; // Nko is the set of Unicode characters in script Nko.
const Nushu = _Nushu; // Nushu is the set of Unicode characters in script Nushu.
const Ogham = _Ogham; // Ogham is the set of Unicode characters in script Ogham.
const Ol_Chiki = _Ol_Chiki; // Ol_Chiki is the set of Unicode characters in script Ol_Chiki.
const Old_Hungarian = _Old_Hungarian; // Old_Hungarian is the set of Unicode characters in script Old_Hungarian.
const Old_Italic = _Old_Italic; // Old_Italic is the set of Unicode characters in script Old_Italic.
const Old_North_Arabian = _Old_North_Arabian; // Old_North_Arabian is the set of Unicode characters in script Old_North_Arabian.
const Old_Permic = _Old_Permic; // Old_Permic is the set of Unicode characters in script Old_Permic.
const Old_Persian = _Old_Persian; // Old_Persian is the set of Unicode characters in script Old_Persian.
const Old_South_Arabian = _Old_South_Arabian; // Old_South_Arabian is the set of Unicode characters in script Old_South_Arabian.
const Old_Turkic = _Old_Turkic; // Old_Turkic is the set of Unicode characters in script Old_Turkic.
const Oriya = _Oriya; // Oriya is the set of Unicode characters in script Oriya.
const Osage = _Osage; // Osage is the set of Unicode characters in script Osage.
const Osmanya = _Osmanya; // Osmanya is the set of Unicode characters in script Osmanya.
const Pahawh_Hmong = _Pahawh_Hmong; // Pahawh_Hmong is the set of Unicode characters in script Pahawh_Hmong.
const Palmyrene = _Palmyrene; // Palmyrene is the set of Unicode characters in script Palmyrene.
const Pau_Cin_Hau = _Pau_Cin_Hau; // Pau_Cin_Hau is the set of Unicode characters in script Pau_Cin_Hau.
const Phags_Pa = _Phags_Pa; // Phags_Pa is the set of Unicode characters in script Phags_Pa.
const Phoenician = _Phoenician; // Phoenician is the set of Unicode characters in script Phoenician.
const Psalter_Pahlavi = _Psalter_Pahlavi; // Psalter_Pahlavi is the set of Unicode characters in script Psalter_Pahlavi.
const Rejang = _Rejang; // Rejang is the set of Unicode characters in script Rejang.
const Runic = _Runic; // Runic is the set of Unicode characters in script Runic.
const Samaritan = _Samaritan; // Samaritan is the set of Unicode characters in script Samaritan.
const Saurashtra = _Saurashtra; // Saurashtra is the set of Unicode characters in script Saurashtra.
const Sharada = _Sharada; // Sharada is the set of Unicode characters in script Sharada.
const Shavian = _Shavian; // Shavian is the set of Unicode characters in script Shavian.
const Siddham = _Siddham; // Siddham is the set of Unicode characters in script Siddham.
const SignWriting = _SignWriting; // SignWriting is the set of Unicode characters in script SignWriting.
const Sinhala = _Sinhala; // Sinhala is the set of Unicode characters in script Sinhala.
const Sora_Sompeng = _Sora_Sompeng; // Sora_Sompeng is the set of Unicode characters in script Sora_Sompeng.
const Soyombo = _Soyombo; // Soyombo is the set of Unicode characters in script Soyombo.
const Sundanese = _Sundanese; // Sundanese is the set of Unicode characters in script Sundanese.
const Syloti_Nagri = _Syloti_Nagri; // Syloti_Nagri is the set of Unicode characters in script Syloti_Nagri.
const Syriac = _Syriac; // Syriac is the set of Unicode characters in script Syriac.
const Tagalog = _Tagalog; // Tagalog is the set of Unicode characters in script Tagalog.
const Tagbanwa = _Tagbanwa; // Tagbanwa is the set of Unicode characters in script Tagbanwa.
const Tai_Le = _Tai_Le; // Tai_Le is the set of Unicode characters in script Tai_Le.
const Tai_Tham = _Tai_Tham; // Tai_Tham is the set of Unicode characters in script Tai_Tham.
const Tai_Viet = _Tai_Viet; // Tai_Viet is the set of Unicode characters in script Tai_Viet.
const Takri = _Takri; // Takri is the set of Unicode characters in script Takri.
const Tamil = _Tamil; // Tamil is the set of Unicode characters in script Tamil.
const Tangut = _Tangut; // Tangut is the set of Unicode characters in script Tangut.
const Telugu = _Telugu; // Telugu is the set of Unicode characters in script Telugu.
const Thaana = _Thaana; // Thaana is the set of Unicode characters in script Thaana.
const Thai = _Thai; // Thai is the set of Unicode characters in script Thai.
const Tibetan = _Tibetan; // Tibetan is the set of Unicode characters in script Tibetan.
const Tifinagh = _Tifinagh; // Tifinagh is the set of Unicode characters in script Tifinagh.
const Tirhuta = _Tirhuta; // Tirhuta is the set of Unicode characters in script Tirhuta.
const Ugaritic = _Ugaritic; // Ugaritic is the set of Unicode characters in script Ugaritic.
const Vai = _Vai; // Vai is the set of Unicode characters in script Vai.
const Warang_Citi = _Warang_Citi; // Warang_Citi is the set of Unicode characters in script Warang_Citi.
const Yi = _Yi; // Yi is the set of Unicode characters in script Yi.
const Zanabazar_Square = _Zanabazar_Square; // Zanabazar_Square is the set of Unicode characters in script Zanabazar_Square.
// Generated by running
...
// These variables have type *RangeTable.
const STerm = _Sentence_Terminal; // STerm is an alias for Sentence_Terminal.
const ASCII_Hex_Digit = _ASCII_Hex_Digit; // ASCII_Hex_Digit is the set of Unicode characters with property ASCII_Hex_Digit.
const Bidi_Control = _Bidi_Control; // Bidi_Control is the set of Unicode characters with property Bidi_Control.
const Dash = _Dash; // Dash is the set of Unicode characters with property Dash.
const Deprecated = _Deprecated; // Deprecated is the set of Unicode characters with property Deprecated.
const Diacritic = _Diacritic; // Diacritic is the set of Unicode characters with property Diacritic.
const Extender = _Extender; // Extender is the set of Unicode characters with property Extender.
const Hex_Digit = _Hex_Digit; // Hex_Digit is the set of Unicode characters with property Hex_Digit.
const Hyphen = _Hyphen; // Hyphen is the set of Unicode characters with property Hyphen.
const IDS_Binary_Operator = _IDS_Binary_Operator; // IDS_Binary_Operator is the set of Unicode characters with property IDS_Binary_Operator.
const IDS_Trinary_Operator = _IDS_Trinary_Operator; // IDS_Trinary_Operator is the set of Unicode characters with property IDS_Trinary_Operator.
const Ideographic = _Ideographic; // Ideographic is the set of Unicode characters with property Ideographic.
const Join_Control = _Join_Control; // Join_Control is the set of Unicode characters with property Join_Control.
const Logical_Order_Exception = _Logical_Order_Exception; // Logical_Order_Exception is the set of Unicode characters with property Logical_Order_Exception.
const Noncharacter_Code_Point = _Noncharacter_Code_Point; // Noncharacter_Code_Point is the set of Unicode characters with property Noncharacter_Code_Point.
const Other_Alphabetic = _Other_Alphabetic; // Other_Alphabetic is the set of Unicode characters with property Other_Alphabetic.
const Other_Default_Ignorable_Code_Point = _Other_Default_Ignorable_Code_Point; // Other_Default_Ignorable_Code_Point is the set of Unicode characters with property Other_Default_Ignorable_Code_Point.
const Other_Grapheme_Extend = _Other_Grapheme_Extend; // Other_Grapheme_Extend is the set of Unicode characters with property Other_Grapheme_Extend.
const Other_ID_Continue = _Other_ID_Continue; // Other_ID_Continue is the set of Unicode characters with property Other_ID_Continue.
const Other_ID_Start = _Other_ID_Start; // Other_ID_Start is the set of Unicode characters with property Other_ID_Start.
const Other_Lowercase = _Other_Lowercase; // Other_Lowercase is the set of Unicode characters with property Other_Lowercase.
const Other_Math = _Other_Math; // Other_Math is the set of Unicode characters with property Other_Math.
const Other_Uppercase = _Other_Uppercase; // Other_Uppercase is the set of Unicode characters with property Other_Uppercase.
const Pattern_Syntax = _Pattern_Syntax; // Pattern_Syntax is the set of Unicode characters with property Pattern_Syntax.
const Pattern_White_Space = _Pattern_White_Space; // Pattern_White_Space is the set of Unicode characters with property Pattern_White_Space.
const Prepended_Concatenation_Mark = _Prepended_Concatenation_Mark; // Prepended_Concatenation_Mark is the set of Unicode characters with property Prepended_Concatenation_Mark.
const Quotation_Mark = _Quotation_Mark; // Quotation_Mark is the set of Unicode characters with property Quotation_Mark.
const Radical = _Radical; // Radical is the set of Unicode characters with property Radical.
const Regional_Indicator = _Regional_Indicator; // Regional_Indicator is the set of Unicode characters with property Regional_Indicator.
const Sentence_Terminal = _Sentence_Terminal; // Sentence_Terminal is the set of Unicode characters with property Sentence_Terminal.
const Soft_Dotted = _Soft_Dotted; // Soft_Dotted is the set of Unicode characters with property Soft_Dotted.
const Terminal_Punctuation = _Terminal_Punctuation; // Terminal_Punctuation is the set of Unicode characters with property Terminal_Punctuation.
const Unified_Ideograph = _Unified_Ideograph; // Unified_Ideograph is the set of Unicode characters with property Unified_Ideograph.
const Variation_Selector = _Variation_Selector; // Variation_Selector is the set of Unicode characters with property Variation_Selector.
const White_Space = _White_Space; // White_Space is the set of Unicode characters with property White_Space.
// Generated by running
...
const _CaseRanges = []CaseRange.{
    CaseRange.init(0x0041, 0x005A, []const u32.{ 0, 32, 0 }),
    CaseRange.init(0x0061, 0x007A, []const u32.{ -32, 0, -32 }),
    CaseRange.init(0x00B5, 0x00B5, []const u32.{ 743, 0, 743 }),
    CaseRange.init(0x00C0, 0x00D6, []const u32.{ 0, 32, 0 }),
    CaseRange.init(0x00D8, 0x00DE, []const u32.{ 0, 32, 0 }),
    CaseRange.init(0x00E0, 0x00F6, []const u32.{ -32, 0, -32 }),
    CaseRange.init(0x00F8, 0x00FE, []const u32.{ -32, 0, -32 }),
    CaseRange.init(0x00FF, 0x00FF, []const u32.{ 121, 0, 121 }),
    CaseRange.init(0x0100, 0x012F, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0130, 0x0130, []const u32.{ 0, -199, 0 }),
    CaseRange.init(0x0131, 0x0131, []const u32.{ -232, 0, -232 }),
    CaseRange.init(0x0132, 0x0137, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0139, 0x0148, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x014A, 0x0177, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0178, 0x0178, []const u32.{ 0, -121, 0 }),
    CaseRange.init(0x0179, 0x017E, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x017F, 0x017F, []const u32.{ -300, 0, -300 }),
    CaseRange.init(0x0180, 0x0180, []const u32.{ 195, 0, 195 }),
    CaseRange.init(0x0181, 0x0181, []const u32.{ 0, 210, 0 }),
    CaseRange.init(0x0182, 0x0185, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0186, 0x0186, []const u32.{ 0, 206, 0 }),
    CaseRange.init(0x0187, 0x0188, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0189, 0x018A, []const u32.{ 0, 205, 0 }),
    CaseRange.init(0x018B, 0x018C, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x018E, 0x018E, []const u32.{ 0, 79, 0 }),
    CaseRange.init(0x018F, 0x018F, []const u32.{ 0, 202, 0 }),
    CaseRange.init(0x0190, 0x0190, []const u32.{ 0, 203, 0 }),
    CaseRange.init(0x0191, 0x0192, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0193, 0x0193, []const u32.{ 0, 205, 0 }),
    CaseRange.init(0x0194, 0x0194, []const u32.{ 0, 207, 0 }),
    CaseRange.init(0x0195, 0x0195, []const u32.{ 97, 0, 97 }),
    CaseRange.init(0x0196, 0x0196, []const u32.{ 0, 211, 0 }),
    CaseRange.init(0x0197, 0x0197, []const u32.{ 0, 209, 0 }),
    CaseRange.init(0x0198, 0x0199, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x019A, 0x019A, []const u32.{ 163, 0, 163 }),
    CaseRange.init(0x019C, 0x019C, []const u32.{ 0, 211, 0 }),
    CaseRange.init(0x019D, 0x019D, []const u32.{ 0, 213, 0 }),
    CaseRange.init(0x019E, 0x019E, []const u32.{ 130, 0, 130 }),
    CaseRange.init(0x019F, 0x019F, []const u32.{ 0, 214, 0 }),
    CaseRange.init(0x01A0, 0x01A5, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01A6, 0x01A6, []const u32.{ 0, 218, 0 }),
    CaseRange.init(0x01A7, 0x01A8, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01A9, 0x01A9, []const u32.{ 0, 218, 0 }),
    CaseRange.init(0x01AC, 0x01AD, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01AE, 0x01AE, []const u32.{ 0, 218, 0 }),
    CaseRange.init(0x01AF, 0x01B0, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01B1, 0x01B2, []const u32.{ 0, 217, 0 }),
    CaseRange.init(0x01B3, 0x01B6, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01B7, 0x01B7, []const u32.{ 0, 219, 0 }),
    CaseRange.init(0x01B8, 0x01B9, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01BC, 0x01BD, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01BF, 0x01BF, []const u32.{ 56, 0, 56 }),
    CaseRange.init(0x01C4, 0x01C4, []const u32.{ 0, 2, 1 }),
    CaseRange.init(0x01C5, 0x01C5, []const u32.{ -1, 1, 0 }),
    CaseRange.init(0x01C6, 0x01C6, []const u32.{ -2, 0, -1 }),
    CaseRange.init(0x01C7, 0x01C7, []const u32.{ 0, 2, 1 }),
    CaseRange.init(0x01C8, 0x01C8, []const u32.{ -1, 1, 0 }),
    CaseRange.init(0x01C9, 0x01C9, []const u32.{ -2, 0, -1 }),
    CaseRange.init(0x01CA, 0x01CA, []const u32.{ 0, 2, 1 }),
    CaseRange.init(0x01CB, 0x01CB, []const u32.{ -1, 1, 0 }),
    CaseRange.init(0x01CC, 0x01CC, []const u32.{ -2, 0, -1 }),
    CaseRange.init(0x01CD, 0x01DC, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01DD, 0x01DD, []const u32.{ -79, 0, -79 }),
    CaseRange.init(0x01DE, 0x01EF, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01F1, 0x01F1, []const u32.{ 0, 2, 1 }),
    CaseRange.init(0x01F2, 0x01F2, []const u32.{ -1, 1, 0 }),
    CaseRange.init(0x01F3, 0x01F3, []const u32.{ -2, 0, -1 }),
    CaseRange.init(0x01F4, 0x01F5, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x01F6, 0x01F6, []const u32.{ 0, -97, 0 }),
    CaseRange.init(0x01F7, 0x01F7, []const u32.{ 0, -56, 0 }),
    CaseRange.init(0x01F8, 0x021F, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0220, 0x0220, []const u32.{ 0, -130, 0 }),
    CaseRange.init(0x0222, 0x0233, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x023A, 0x023A, []const u32.{ 0, 10795, 0 }),
    CaseRange.init(0x023B, 0x023C, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x023D, 0x023D, []const u32.{ 0, -163, 0 }),
    CaseRange.init(0x023E, 0x023E, []const u32.{ 0, 10792, 0 }),
    CaseRange.init(0x023F, 0x0240, []const u32.{ 10815, 0, 10815 }),
    CaseRange.init(0x0241, 0x0242, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0243, 0x0243, []const u32.{ 0, -195, 0 }),
    CaseRange.init(0x0244, 0x0244, []const u32.{ 0, 69, 0 }),
    CaseRange.init(0x0245, 0x0245, []const u32.{ 0, 71, 0 }),
    CaseRange.init(0x0246, 0x024F, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0250, 0x0250, []const u32.{ 10783, 0, 10783 }),
    CaseRange.init(0x0251, 0x0251, []const u32.{ 10780, 0, 10780 }),
    CaseRange.init(0x0252, 0x0252, []const u32.{ 10782, 0, 10782 }),
    CaseRange.init(0x0253, 0x0253, []const u32.{ -210, 0, -210 }),
    CaseRange.init(0x0254, 0x0254, []const u32.{ -206, 0, -206 }),
    CaseRange.init(0x0256, 0x0257, []const u32.{ -205, 0, -205 }),
    CaseRange.init(0x0259, 0x0259, []const u32.{ -202, 0, -202 }),
    CaseRange.init(0x025B, 0x025B, []const u32.{ -203, 0, -203 }),
    CaseRange.init(0x025C, 0x025C, []const u32.{ 42319, 0, 42319 }),
    CaseRange.init(0x0260, 0x0260, []const u32.{ -205, 0, -205 }),
    CaseRange.init(0x0261, 0x0261, []const u32.{ 42315, 0, 42315 }),
    CaseRange.init(0x0263, 0x0263, []const u32.{ -207, 0, -207 }),
    CaseRange.init(0x0265, 0x0265, []const u32.{ 42280, 0, 42280 }),
    CaseRange.init(0x0266, 0x0266, []const u32.{ 42308, 0, 42308 }),
    CaseRange.init(0x0268, 0x0268, []const u32.{ -209, 0, -209 }),
    CaseRange.init(0x0269, 0x0269, []const u32.{ -211, 0, -211 }),
    CaseRange.init(0x026A, 0x026A, []const u32.{ 42308, 0, 42308 }),
    CaseRange.init(0x026B, 0x026B, []const u32.{ 10743, 0, 10743 }),
    CaseRange.init(0x026C, 0x026C, []const u32.{ 42305, 0, 42305 }),
    CaseRange.init(0x026F, 0x026F, []const u32.{ -211, 0, -211 }),
    CaseRange.init(0x0271, 0x0271, []const u32.{ 10749, 0, 10749 }),
    CaseRange.init(0x0272, 0x0272, []const u32.{ -213, 0, -213 }),
    CaseRange.init(0x0275, 0x0275, []const u32.{ -214, 0, -214 }),
    CaseRange.init(0x027D, 0x027D, []const u32.{ 10727, 0, 10727 }),
    CaseRange.init(0x0280, 0x0280, []const u32.{ -218, 0, -218 }),
    CaseRange.init(0x0283, 0x0283, []const u32.{ -218, 0, -218 }),
    CaseRange.init(0x0287, 0x0287, []const u32.{ 42282, 0, 42282 }),
    CaseRange.init(0x0288, 0x0288, []const u32.{ -218, 0, -218 }),
    CaseRange.init(0x0289, 0x0289, []const u32.{ -69, 0, -69 }),
    CaseRange.init(0x028A, 0x028B, []const u32.{ -217, 0, -217 }),
    CaseRange.init(0x028C, 0x028C, []const u32.{ -71, 0, -71 }),
    CaseRange.init(0x0292, 0x0292, []const u32.{ -219, 0, -219 }),
    CaseRange.init(0x029D, 0x029D, []const u32.{ 42261, 0, 42261 }),
    CaseRange.init(0x029E, 0x029E, []const u32.{ 42258, 0, 42258 }),
    CaseRange.init(0x0345, 0x0345, []const u32.{ 84, 0, 84 }),
    CaseRange.init(0x0370, 0x0373, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0376, 0x0377, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x037B, 0x037D, []const u32.{ 130, 0, 130 }),
    CaseRange.init(0x037F, 0x037F, []const u32.{ 0, 116, 0 }),
    CaseRange.init(0x0386, 0x0386, []const u32.{ 0, 38, 0 }),
    CaseRange.init(0x0388, 0x038A, []const u32.{ 0, 37, 0 }),
    CaseRange.init(0x038C, 0x038C, []const u32.{ 0, 64, 0 }),
    CaseRange.init(0x038E, 0x038F, []const u32.{ 0, 63, 0 }),
    CaseRange.init(0x0391, 0x03A1, []const u32.{ 0, 32, 0 }),
    CaseRange.init(0x03A3, 0x03AB, []const u32.{ 0, 32, 0 }),
    CaseRange.init(0x03AC, 0x03AC, []const u32.{ -38, 0, -38 }),
    CaseRange.init(0x03AD, 0x03AF, []const u32.{ -37, 0, -37 }),
    CaseRange.init(0x03B1, 0x03C1, []const u32.{ -32, 0, -32 }),
    CaseRange.init(0x03C2, 0x03C2, []const u32.{ -31, 0, -31 }),
    CaseRange.init(0x03C3, 0x03CB, []const u32.{ -32, 0, -32 }),
    CaseRange.init(0x03CC, 0x03CC, []const u32.{ -64, 0, -64 }),
    CaseRange.init(0x03CD, 0x03CE, []const u32.{ -63, 0, -63 }),
    CaseRange.init(0x03CF, 0x03CF, []const u32.{ 0, 8, 0 }),
    CaseRange.init(0x03D0, 0x03D0, []const u32.{ -62, 0, -62 }),
    CaseRange.init(0x03D1, 0x03D1, []const u32.{ -57, 0, -57 }),
    CaseRange.init(0x03D5, 0x03D5, []const u32.{ -47, 0, -47 }),
    CaseRange.init(0x03D6, 0x03D6, []const u32.{ -54, 0, -54 }),
    CaseRange.init(0x03D7, 0x03D7, []const u32.{ -8, 0, -8 }),
    CaseRange.init(0x03D8, 0x03EF, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x03F0, 0x03F0, []const u32.{ -86, 0, -86 }),
    CaseRange.init(0x03F1, 0x03F1, []const u32.{ -80, 0, -80 }),
    CaseRange.init(0x03F2, 0x03F2, []const u32.{ 7, 0, 7 }),
    CaseRange.init(0x03F3, 0x03F3, []const u32.{ -116, 0, -116 }),
    CaseRange.init(0x03F4, 0x03F4, []const u32.{ 0, -60, 0 }),
    CaseRange.init(0x03F5, 0x03F5, []const u32.{ -96, 0, -96 }),
    CaseRange.init(0x03F7, 0x03F8, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x03F9, 0x03F9, []const u32.{ 0, -7, 0 }),
    CaseRange.init(0x03FA, 0x03FB, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x03FD, 0x03FF, []const u32.{ 0, -130, 0 }),
    CaseRange.init(0x0400, 0x040F, []const u32.{ 0, 80, 0 }),
    CaseRange.init(0x0410, 0x042F, []const u32.{ 0, 32, 0 }),
    CaseRange.init(0x0430, 0x044F, []const u32.{ -32, 0, -32 }),
    CaseRange.init(0x0450, 0x045F, []const u32.{ -80, 0, -80 }),
    CaseRange.init(0x0460, 0x0481, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x048A, 0x04BF, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x04C0, 0x04C0, []const u32.{ 0, 15, 0 }),
    CaseRange.init(0x04C1, 0x04CE, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x04CF, 0x04CF, []const u32.{ -15, 0, -15 }),
    CaseRange.init(0x04D0, 0x052F, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x0531, 0x0556, []const u32.{ 0, 48, 0 }),
    CaseRange.init(0x0561, 0x0586, []const u32.{ -48, 0, -48 }),
    CaseRange.init(0x10A0, 0x10C5, []const u32.{ 0, 7264, 0 }),
    CaseRange.init(0x10C7, 0x10C7, []const u32.{ 0, 7264, 0 }),
    CaseRange.init(0x10CD, 0x10CD, []const u32.{ 0, 7264, 0 }),
    CaseRange.init(0x13A0, 0x13EF, []const u32.{ 0, 38864, 0 }),
    CaseRange.init(0x13F0, 0x13F5, []const u32.{ 0, 8, 0 }),
    CaseRange.init(0x13F8, 0x13FD, []const u32.{ -8, 0, -8 }),
    CaseRange.init(0x1C80, 0x1C80, []const u32.{ -6254, 0, -6254 }),
    CaseRange.init(0x1C81, 0x1C81, []const u32.{ -6253, 0, -6253 }),
    CaseRange.init(0x1C82, 0x1C82, []const u32.{ -6244, 0, -6244 }),
    CaseRange.init(0x1C83, 0x1C84, []const u32.{ -6242, 0, -6242 }),
    CaseRange.init(0x1C85, 0x1C85, []const u32.{ -6243, 0, -6243 }),
    CaseRange.init(0x1C86, 0x1C86, []const u32.{ -6236, 0, -6236 }),
    CaseRange.init(0x1C87, 0x1C87, []const u32.{ -6181, 0, -6181 }),
    CaseRange.init(0x1C88, 0x1C88, []const u32.{ 35266, 0, 35266 }),
    CaseRange.init(0x1D79, 0x1D79, []const u32.{ 35332, 0, 35332 }),
    CaseRange.init(0x1D7D, 0x1D7D, []const u32.{ 3814, 0, 3814 }),
    CaseRange.init(0x1E00, 0x1E95, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x1E9B, 0x1E9B, []const u32.{ -59, 0, -59 }),
    CaseRange.init(0x1E9E, 0x1E9E, []const u32.{ 0, -7615, 0 }),
    CaseRange.init(0x1EA0, 0x1EFF, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x1F00, 0x1F07, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F08, 0x1F0F, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F10, 0x1F15, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F18, 0x1F1D, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F20, 0x1F27, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F28, 0x1F2F, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F30, 0x1F37, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F38, 0x1F3F, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F40, 0x1F45, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F48, 0x1F4D, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F51, 0x1F51, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F53, 0x1F53, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F55, 0x1F55, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F57, 0x1F57, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F59, 0x1F59, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F5B, 0x1F5B, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F5D, 0x1F5D, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F5F, 0x1F5F, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F60, 0x1F67, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F68, 0x1F6F, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F70, 0x1F71, []const u32.{ 74, 0, 74 }),
    CaseRange.init(0x1F72, 0x1F75, []const u32.{ 86, 0, 86 }),
    CaseRange.init(0x1F76, 0x1F77, []const u32.{ 100, 0, 100 }),
    CaseRange.init(0x1F78, 0x1F79, []const u32.{ 128, 0, 128 }),
    CaseRange.init(0x1F7A, 0x1F7B, []const u32.{ 112, 0, 112 }),
    CaseRange.init(0x1F7C, 0x1F7D, []const u32.{ 126, 0, 126 }),
    CaseRange.init(0x1F80, 0x1F87, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F88, 0x1F8F, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1F90, 0x1F97, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1F98, 0x1F9F, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1FA0, 0x1FA7, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1FA8, 0x1FAF, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1FB0, 0x1FB1, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1FB3, 0x1FB3, []const u32.{ 9, 0, 9 }),
    CaseRange.init(0x1FB8, 0x1FB9, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1FBA, 0x1FBB, []const u32.{ 0, -74, 0 }),
    CaseRange.init(0x1FBC, 0x1FBC, []const u32.{ 0, -9, 0 }),
    CaseRange.init(0x1FBE, 0x1FBE, []const u32.{ -7205, 0, -7205 }),
    CaseRange.init(0x1FC3, 0x1FC3, []const u32.{ 9, 0, 9 }),
    CaseRange.init(0x1FC8, 0x1FCB, []const u32.{ 0, -86, 0 }),
    CaseRange.init(0x1FCC, 0x1FCC, []const u32.{ 0, -9, 0 }),
    CaseRange.init(0x1FD0, 0x1FD1, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1FD8, 0x1FD9, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1FDA, 0x1FDB, []const u32.{ 0, -100, 0 }),
    CaseRange.init(0x1FE0, 0x1FE1, []const u32.{ 8, 0, 8 }),
    CaseRange.init(0x1FE5, 0x1FE5, []const u32.{ 7, 0, 7 }),
    CaseRange.init(0x1FE8, 0x1FE9, []const u32.{ 0, -8, 0 }),
    CaseRange.init(0x1FEA, 0x1FEB, []const u32.{ 0, -112, 0 }),
    CaseRange.init(0x1FEC, 0x1FEC, []const u32.{ 0, -7, 0 }),
    CaseRange.init(0x1FF3, 0x1FF3, []const u32.{ 9, 0, 9 }),
    CaseRange.init(0x1FF8, 0x1FF9, []const u32.{ 0, -128, 0 }),
    CaseRange.init(0x1FFA, 0x1FFB, []const u32.{ 0, -126, 0 }),
    CaseRange.init(0x1FFC, 0x1FFC, []const u32.{ 0, -9, 0 }),
    CaseRange.init(0x2126, 0x2126, []const u32.{ 0, -7517, 0 }),
    CaseRange.init(0x212A, 0x212A, []const u32.{ 0, -8383, 0 }),
    CaseRange.init(0x212B, 0x212B, []const u32.{ 0, -8262, 0 }),
    CaseRange.init(0x2132, 0x2132, []const u32.{ 0, 28, 0 }),
    CaseRange.init(0x214E, 0x214E, []const u32.{ -28, 0, -28 }),
    CaseRange.init(0x2160, 0x216F, []const u32.{ 0, 16, 0 }),
    CaseRange.init(0x2170, 0x217F, []const u32.{ -16, 0, -16 }),
    CaseRange.init(0x2183, 0x2184, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x24B6, 0x24CF, []const u32.{ 0, 26, 0 }),
    CaseRange.init(0x24D0, 0x24E9, []const u32.{ -26, 0, -26 }),
    CaseRange.init(0x2C00, 0x2C2E, []const u32.{ 0, 48, 0 }),
    CaseRange.init(0x2C30, 0x2C5E, []const u32.{ -48, 0, -48 }),
    CaseRange.init(0x2C60, 0x2C61, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x2C62, 0x2C62, []const u32.{ 0, -10743, 0 }),
    CaseRange.init(0x2C63, 0x2C63, []const u32.{ 0, -3814, 0 }),
    CaseRange.init(0x2C64, 0x2C64, []const u32.{ 0, -10727, 0 }),
    CaseRange.init(0x2C65, 0x2C65, []const u32.{ -10795, 0, -10795 }),
    CaseRange.init(0x2C66, 0x2C66, []const u32.{ -10792, 0, -10792 }),
    CaseRange.init(0x2C67, 0x2C6C, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x2C6D, 0x2C6D, []const u32.{ 0, -10780, 0 }),
    CaseRange.init(0x2C6E, 0x2C6E, []const u32.{ 0, -10749, 0 }),
    CaseRange.init(0x2C6F, 0x2C6F, []const u32.{ 0, -10783, 0 }),
    CaseRange.init(0x2C70, 0x2C70, []const u32.{ 0, -10782, 0 }),
    CaseRange.init(0x2C72, 0x2C73, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x2C75, 0x2C76, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x2C7E, 0x2C7F, []const u32.{ 0, -10815, 0 }),
    CaseRange.init(0x2C80, 0x2CE3, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x2CEB, 0x2CEE, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x2CF2, 0x2CF3, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0x2D00, 0x2D25, []const u32.{ -7264, 0, -7264 }),
    CaseRange.init(0x2D27, 0x2D27, []const u32.{ -7264, 0, -7264 }),
    CaseRange.init(0x2D2D, 0x2D2D, []const u32.{ -7264, 0, -7264 }),
    CaseRange.init(0xA640, 0xA66D, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA680, 0xA69B, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA722, 0xA72F, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA732, 0xA76F, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA779, 0xA77C, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA77D, 0xA77D, []const u32.{ 0, -35332, 0 }),
    CaseRange.init(0xA77E, 0xA787, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA78B, 0xA78C, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA78D, 0xA78D, []const u32.{ 0, -42280, 0 }),
    CaseRange.init(0xA790, 0xA793, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA796, 0xA7A9, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xA7AA, 0xA7AA, []const u32.{ 0, -42308, 0 }),
    CaseRange.init(0xA7AB, 0xA7AB, []const u32.{ 0, -42319, 0 }),
    CaseRange.init(0xA7AC, 0xA7AC, []const u32.{ 0, -42315, 0 }),
    CaseRange.init(0xA7AD, 0xA7AD, []const u32.{ 0, -42305, 0 }),
    CaseRange.init(0xA7AE, 0xA7AE, []const u32.{ 0, -42308, 0 }),
    CaseRange.init(0xA7B0, 0xA7B0, []const u32.{ 0, -42258, 0 }),
    CaseRange.init(0xA7B1, 0xA7B1, []const u32.{ 0, -42282, 0 }),
    CaseRange.init(0xA7B2, 0xA7B2, []const u32.{ 0, -42261, 0 }),
    CaseRange.init(0xA7B3, 0xA7B3, []const u32.{ 0, 928, 0 }),
    CaseRange.init(0xA7B4, 0xA7B7, []const u32.{ base.upper_lower, base.upper_lower, base.upper_lower }),
    CaseRange.init(0xAB53, 0xAB53, []const u32.{ -928, 0, -928 }),
    CaseRange.init(0xAB70, 0xABBF, []const u32.{ -38864, 0, -38864 }),
    CaseRange.init(0xFF21, 0xFF3A, []const u32.{ 0, 32, 0 }),
    CaseRange.init(0xFF41, 0xFF5A, []const u32.{ -32, 0, -32 }),
    CaseRange.init(0x10400, 0x10427, []const u32.{ 0, 40, 0 }),
    CaseRange.init(0x10428, 0x1044F, []const u32.{ -40, 0, -40 }),
    CaseRange.init(0x104B0, 0x104D3, []const u32.{ 0, 40, 0 }),
    CaseRange.init(0x104D8, 0x104FB, []const u32.{ -40, 0, -40 }),
    CaseRange.init(0x10C80, 0x10CB2, []const u32.{ 0, 64, 0 }),
    CaseRange.init(0x10CC0, 0x10CF2, []const u32.{ -64, 0, -64 }),
    CaseRange.init(0x118A0, 0x118BF, []const u32.{ 0, 32, 0 }),
    CaseRange.init(0x118C0, 0x118DF, []const u32.{ -32, 0, -32 }),
    CaseRange.init(0x1E900, 0x1E921, []const u32.{ 0, 34, 0 }),
    CaseRange.init(0x1E922, 0x1E943, []const u32.{ -34, 0, -34 }),
};
